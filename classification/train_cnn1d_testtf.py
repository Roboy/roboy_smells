...
class CNNTrainable(tune.Trainable):
    def _setup(self, config):
        ...
        self.train_ds = tf.data.Dataset.from_tensor_slices((train_batch, train_batch)).batch(batch_size)
        self.val_ds = tf.data.Dataset.from_tensor_slices((val_batch, val_batch)).batch(batch_size)
